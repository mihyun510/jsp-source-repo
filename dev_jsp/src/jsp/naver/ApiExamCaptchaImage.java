...
public class ApiExamCaptchaImage {
	public ApiExamCaptchaImage(String key) {
		//키값을 가지고 이미지을 생성하는지 확인
	}
	//클라이언트ID: NEzgA8FpF7thgoIuuLtp - 키값을 넣어줘야된다...?
	//클라이언트 시크릿값 :jpVUpv3RhC
	//{"key":"xxxxxxxxx"} - 발급받은 키값
 public static void main(String[] args) {
	 if(args.length!=1) { //파라미터로 값이 안들어왔다
     ...
     String key= args[0]; //키값이 믿의 값의 파라미터로 전달이된다.??..?
